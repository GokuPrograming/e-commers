...
import Venta_total_component from './Venta_total_component';

function Admin_panel_component(): ReactElement {
    const [content, setContent] = useState<ReactElement | null>(null);

    const handleProducts = () => {
        setContent(

            <Venta_total_component>
            </Venta_total_component>
        );
    };
                    ...
                    <div className="relative flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white pt-0">
                        <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                            <div className="flex-1 px-3 bg-white divide-y space-y-1">
                                {/* primer parte de barra */}
                                <ul className="space-y-2 pb-2">

                                    <li>
                                        <button onClick={handleProducts} className="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                                ...
                                <div className="space-y-2 pt-2">
                                    <button onClick={handleProducts} className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2">
...
export default Admin_panel_component
