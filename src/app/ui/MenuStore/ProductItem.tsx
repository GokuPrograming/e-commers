    ...
    <div className="relative flex overflow-hidden rounded-xl">
        ...
        <div className="w-1/2 md:w-2/3 lg:w-3/4 bg-white p-3">
            ...
            <div className="flex items-center space-x-1.5 mt-2">
                <button className="text-sm bg-green-500 px-4 py-1.5 text-white rounded-lg duration-100 hover:border-l-orange-300-600" onClick={handleAddToCartClick}>Add to cart</button>
                <button className="text-sm bg-blue-500 px-4 py-1.5 text-white rounded-lg duration-100 hover:bg-blue-600" onClick={handleAddToCartClick}>ver mas</button>
            </div>
        </div>
    </div>
</article>
